    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        <div className="flex min-h-screen flex-col bg-[linear-gradient(180deg,_rgba(247,245,241,1)_0%,_rgba(255,255,255,1)_24%)]">
          <header className="sticky top-0 z-20 flex min-h-16 items-center gap-3 border-b border-border/70 bg-background/90 px-4 py-3 backdrop-blur md:px-6">
          ...
          <main
            className="flex-1 px-4 py-5 pb-[calc(env(safe-area-inset-bottom)+1.5rem)] transition-opacity md:px-6 md:py-6">
