...
function LandingPage() {
  return (
    <div
      ...
      className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(230,190,138,0.16),_transparent_35%),linear-gradient(180deg,_rgba(246,242,235,1)_0%,_rgba(255,255,255,1)_100%)]"
    >
